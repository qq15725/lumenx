...
abstract class RequestValidate extends Request implements ValidatesWhenResolved
{
     ...
     * @return $this
     */
    public function setContainer(Container $container): RequestValidate
    {
